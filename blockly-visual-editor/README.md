...
- Text in Eingabefeldern der Blöcke ist beim Tippen wieder sichtbar

## Was ist neu in 0.6.5

- Der Block „erstelle Text aus“ hat leere Anschlüsse; Text, Entitäten und andere Blöcke können frei angedockt werden

## Was ist neu in 0.6.4

- Im Dialog „Benachrichtigung senden an“ stehen die Personen wieder neben den Geräten

## Was ist neu in 0.6.3

- Schwarze Schrift auf hellen Textblöcken
- Moderne, runde Eingabefelder und Dropdowns bei den bisherigen 3D-Blöcken
